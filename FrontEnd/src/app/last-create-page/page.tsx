      ...
      <div style={{ backgroundColor: "rgb(207,242,251)" }}>
        <div className="container position-relative ">
          <Tab.Container
            ...
            defaultActiveKey="last-create-page"
          >
            <Row className="" >
              {!isHiddenSidebar && (
                             <SidebarInformation isSidebarInSmall = {isSidebarInSmall} eventKey="last-create-page" handleSideBar = {handleSideBar}></SidebarInformation>
