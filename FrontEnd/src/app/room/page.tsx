...
function DataStatistics() {
  ...
  const router = useRouter();
    ...
    const [searchroom, setroomData] = useState('');
      ...
      <div style={{ backgroundColor: "rgb(207,242,251)" }}>
        <div className="container-fluid position-relative ">
          ...
          >
            <Row className="" >
              {!isHiddenSidebar && (
                             <SidebarInformation isSidebarInSmall = {isSidebarInSmall} eventKey="room" handleSideBar = {handleSideBar}></SidebarInformation>
